      ...
      <el-card>
        ...
        <div style="margin-bottom:50px;">
          <el-col :span="6" class="text-center">
            <router-link class="pan-btn light-blue-btn" to="/icons/index">
              Icons
            </router-link>
          </el-col>
          <el-col :span="6" class="text-center">
          ...
          <el-col :span="6" class="text-center">
            <router-link class="pan-btn green-btn" to="/active/list">
              Active
            </router-link>
          </el-col>
    ...
    <el-row :gutter="20" style="margin-top:50px;">
      ...
      <el-col :span="6">
        <el-card class="box-card">
          ...
          <div class="component-item">
            <mallki class-name="mallki-text" text="Sk-Manager"/>
          </div>
        </el-card>
      </el-col>
    </el-row>
...
<script>
  ...
  export default {
    name: "Mixin",
    components: {MdInput, PanThumb, Mallki,DropdownMenu},
    directives: {
      waves
    },
    data() {
